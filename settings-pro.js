...
(()=>{
  ...
  function applyTheme(theme=read().theme||'system'){
    ...
    document.querySelector('meta[name="theme-color"]')?.setAttribute('content',dark?'#091426':'#e9f0fb');
  }
  applyTheme();
